...
namespace wServer.realm.worlds
{
    public class PetYard : World
    {
        ...
        protected override void Init()
        {
            ...
            {
                case 1:
                    petYard = "wServer.realm.worlds.maps.PetYard_Common.wmap";
                    break;

                case 2:
                    petYard = "wServer.realm.worlds.maps.PetYard_Uncommon.wmap";
                    break;

                case 3:
                    petYard = "wServer.realm.worlds.maps.PetYard_Rare.wmap";
                    break;

                case 4:
                    petYard = "wServer.realm.worlds.maps.PetYard_Legendary.wmap";
                    break;

                case 5:
                    petYard = "wServer.realm.worlds.maps.PetYard_Divine.wmap";
                    break;
            }
            ...
            Manager.Database.DoActionAsync(db =>
            {
                ...
                using (MySqlDataReader rdr = cmd.ExecuteReader())
                {
                    while (rdr.Read())
                    {
                        ...
                        if (player.Pet != null && player.Pet.PetId == petId)
                            continue;
