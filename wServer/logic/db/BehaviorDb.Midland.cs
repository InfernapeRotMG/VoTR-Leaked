    ...
    partial class BehaviorDb
    {
        private _ Midland = () => Behav()
            ...
            .Init("Wasp Queen",
                ...
                new ItemLoot("Charcoal", 0.15),
                new ItemLoot("Wheat", 0.07)
            )
            .Init("Worker Wasp",
                new State(
            ...
            .Init("Horned Drake",
                ...
                new ItemLoot("Charcoal", 0.09),
                new ItemLoot("Wheat", 0.12)
            )
            .Init("Drake Baby",
                new State(
                    new State("unharmed",
            ...
            .Init("Great Lizard",
                ...
                new TierLoot(2, ItemType.Ring, 0.07),
                new TierLoot(2, ItemType.Ability, 0.27),
                new ItemLoot("Tomato", 0.05),
                new ItemLoot("Charcoal", 0.12),
                new ItemLoot("Wheat", 0.10)
            )
            .Init("Tawny Warg",
                new State(
