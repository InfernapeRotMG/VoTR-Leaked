...
namespace wServer.realm.entities
{
    public class Pet : Entity, IPlayer
    {
        ...
        public PetLevel GetPetLevelFromAbility(Ability ability, bool checkRarity)
        {
            if (checkRarity)
            {
                if (FirstPetLevel.Ability == ability)
                    return FirstPetLevel;
                else if (SecondPetLevel.Ability == ability && PetRarity >= Rarity.Uncommon)
                    return SecondPetLevel;
                else if (ThirdPetLevel.Ability == ability && PetRarity >= Rarity.Legendary)
                    return ThirdPetLevel;
                return null;
            }
            else
            {
                if (FirstPetLevel.Ability == ability)
                    return FirstPetLevel;
                else if (SecondPetLevel.Ability == ability)
                    return SecondPetLevel;
                else if (ThirdPetLevel.Ability == ability)
                    return ThirdPetLevel;
                return null;
            }
        }
        ...
        public bool IsVisibleToEnemy()
        {
            ...
            if (HasConditionEffect(global::db.data.ConditionEffectIndex.Stasis))
                return false;
            return true;
        }
