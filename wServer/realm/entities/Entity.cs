...
namespace wServer.realm.entities
{
    ...
    {
        private const int EFFECT_COUNT = 49;
        ...
        private bool ApplyCondition(ConditionEffectIndex effect)
        {
            if (effect == ConditionEffectIndex.Stunned &&
                HasConditionEffect(ConditionEffects.StunImmume) || effect == ConditionEffectIndex.Stunned &&
                HasConditionEffect(ConditionEffects.Empowered))
                return false;
            ...
            if (effect == ConditionEffectIndex.Paralyzed &&
                HasConditionEffect(ConditionEffects.ParalyzeImmune) || effect == ConditionEffectIndex.Paralyzed &&
                HasConditionEffect(ConditionEffects.Empowered))
                return false;
