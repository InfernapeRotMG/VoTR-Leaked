...
namespace db.data
{
	...
	public class ActivateEffect
	{
		public ActivateEffect(XElement elem)
		{
			...
			if (elem.Attribute("LootboxName") != null)
				LootboxName = elem.Attribute("LootboxName").Value;
		}
		...
		public bool noStack { get; private set; } //noStack support finalized
	}
	...
	public class Item : IFeedable
	{
		...
		public Item(ushort type, XElement elem)
		{
			try
			{
				...
				Lootbox = elem.Element("Lootbox") != null;
				Task = elem.Element("Task") != null;
				ActiveTask = elem.Element("ActiveTask") != null;
				Fabled = elem.Element("Fabled") != null;
				FabledToken = elem.Element("FabledToken") != null;
				Outfit = elem.Element("Outfit") != null;
				Mark = elem.Element("Mark") != null;
				SorMachine = elem.Element("SorMachine") != null;
				...
				MMResistance = elem.Element("MMResistance") != null;
				CResistance = elem.Element("CResistance") != null;
				GResistance = elem.Element("GResistance") != null;
				...
				SPAbility = elem.Element("SPAbility") != null;
				BWAbility = elem.Element("BWAbility") != null;
				VRAbility = elem.Element("VRAbility") != null;
		...
		public bool Lootbox { get; private set; }
		...
		public bool SPAbility { get; private set; }
		public bool BWAbility { get; private set; }
		public bool VRAbility { get; private set; }
