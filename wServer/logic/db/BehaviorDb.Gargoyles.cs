        ...
        private _ Gargoyles = () => Behav()
			.Init("Lord Stone Gargoyle",
				new State(
					...
					new State("ReturnToHome",
						...
						new ConditionalEffect(ConditionEffectIndex.Invincible),
						new ReturnToSpawn(once: true, speed: 1.4),
						new TimedTransition(8000, "Petrican")
					),
					new State("Petrican",
						new Grenade(5, 160, range: 9, coolDown: 5000),
						new TossObject("Baby Stone Gargoyle", 4, 0, coolDown: 100000, randomToss: false),
						new TossObject("Baby Stone Gargoyle", 4, 45, coolDown: 100000, randomToss: false),
						new TossObject("Baby Stone Gargoyle", 4, 90, coolDown: 100000, randomToss: false),
						new TossObject("Baby Stone Gargoyle", 4, 135, coolDown: 100000, randomToss: false),
						new TossObject("Baby Stone Gargoyle", 4, 180, coolDown: 100000, randomToss: false),
						new TossObject("Baby Stone Gargoyle", 4, 225, coolDown: 100000, randomToss: false),
						new TossObject("Baby Stone Gargoyle", 4, 270, coolDown: 100000, randomToss: false),
						new TossObject("Baby Stone Gargoyle", 4, 315, coolDown: 100000, randomToss: false),
			...
			.Init("Stone Gargoyle",
					new State(
						...
						new Heal(60, "LSG Group", coolDown: 6000),
					new State("start"
					),
					new State("swag",
						new SetAltTexture(1),
