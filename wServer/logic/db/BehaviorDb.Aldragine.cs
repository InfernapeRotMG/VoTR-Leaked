    ...
    partial class BehaviorDb
    {
        ...
        .Init("Corrupted Stone Giant C",
            new State(
                ...
                new SpecificHeal(8, 1000, "Self", coolDown: 2000),
                new TransformOnDeath("Headless Stone Giant", 1, 1, 1),
                new Orbit(0.3, 3, 20),
                new State("fight1",
        ...
        .Init("Cleric of Zol",
                new State(
                    new Wander(0.6),
                    new SpecificHeal(8, 50, "Zol", coolDown: 6000),
        ...
        .Init("AH The Vision of Aldragine",
                new State(
                   ...
                   new State(
                    ...
                    new State("nextfam2",
                        new SpecificHeal(1, 50000, "Self", coolDown: 2500),
        ...
        .Init("AH Aldragine",
                new State(
                    ...
                    new State("KillStones2",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new SpecificHeal(1, 2500, "Self", coolDown: 3000),
                        new Flash(0x0F00F0, 1, 2),
