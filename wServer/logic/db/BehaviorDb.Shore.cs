...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        private _ Shore = () => Behav()
            .Init("Pirate",
                new State(
                    new DropPortalOnDeath("Pirate Cave Portal", 15),
                    new Prioritize(
            ...
            .Init("Bandit Leader",
                new State(
                    new DropPortalOnDeath("Pirate Cave Portal", 25),
                ...
                new ItemLoot("Wheat", 0.14)
            )
            .Init("Red Gelatinous Cube",
                new State(
                    new DropPortalOnDeath("Pirate Cave Portal", 10),
