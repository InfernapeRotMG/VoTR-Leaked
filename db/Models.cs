...
namespace db
{
    ...
    public class VaultData
    {
        ...
        public ushort[] Items
        {
            get { return Utils.FromCommaSepString16z(_Items); }
        ...
        [XmlIgnore]
        public db.ItemData[] Datas
        {
            get { return db.ItemDataList.CreateData(_Datas); }
            set { _Datas = db.ItemDataList.GetJson(value); }
        }
    }
    ...
    public class Char
    {
        ...
        [XmlIgnore]
        public db.ItemData[] EquipData
        {
            get { return db.ItemDataList.CreateData(_EquipData); }
            set { _EquipData = db.ItemDataList.GetJson(value); }
        }
