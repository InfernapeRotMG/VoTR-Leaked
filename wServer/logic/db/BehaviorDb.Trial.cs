...
namespace wServer.logic
{
    partial class BehaviorDb
    {
        ...
        .Init("CR Mini Blocker",
                ...
                .Init("CR Spawner 3",
            new State(
                new DropPortalOnDeath("Crypt of the Illusionist Portal", 100, PortalDespawnTimeSec: 180),
                new ConditionalEffect(ConditionEffectIndex.Invincible),
                new State("idle",
              ...
              .Init("The Illusionist",
                new State(
                    ...
                    new State("startfirst",
                        new TossObject("CR Pillar of Illusions", 8, 0, coolDown: 9999999, randomToss: false),
                        new TossObject("CR Pillar of Illusions", 8, 90, coolDown: 9999999, randomToss: false),
                        new TossObject("CR Pillar of Illusions", 8, 180, coolDown: 9999999, randomToss: false),
                        new TossObject("CR Pillar of Illusions", 8, 270, coolDown: 9999999, randomToss: false),
                        new TimedTransition(5000, "start")
                        )
                      ),
                    new State("start",
                        new TossObject("CR Illusion Manifestation A", range: 8, coolDown: 8000, randomToss: true),
                        new TossObject("CR Illusion Manifestation", range: 8, coolDown: 8000, randomToss: true),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Wander(0.4),
                    ...
                    new State(
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                    new State("sinkstate",
                        new ReturnToSpawn(once: true, speed: 0.6),
                        new SetAltTexture(1),
