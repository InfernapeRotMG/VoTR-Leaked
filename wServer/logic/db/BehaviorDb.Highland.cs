    ...
    partial class BehaviorDb
    {
        private _ Highland = () => Behav()
            .Init("Minotaur",
                ...
                new ItemLoot("Sugar", 0.1),
                new ItemLoot("Cheese", 0.25),
            ...
            .Init("Undead Dwarf King",
                ...
                new ItemLoot("Chocolate Chips", 0.1),
                new ItemLoot("Charcoal", 0.03)
            )
            .Init("Soulless Dwarf",
                new State(
